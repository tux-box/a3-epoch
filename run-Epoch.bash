...
## Updated for this docker container.
#=======================================================================
...
#but you need a folder called tdm in the ${ARMA_DIR} folder
...
#=======================================================================
#ARMA_DIR=${ARMA_DIR}
CONFIG=${ARMA_DIR}/${NAME}/server.cfg
CFG=${ARMA_DIR}/${NAME}/basic.cfg
LOG_DIR=${ARMA_DIR}/logs
BEPATH=${ARMA_DIR}/${NAME}/battleye/
...
case "$1" in
	...
	check)
		...
		echo -ne "\033[33mCFG directory:\033[0m ${ARMA_DIR}/${NAME} "
		if [ -d ${ARMA_DIR}/${NAME} ]; then
		    echo -e "\033[32mOK\033[0m"
		else
		    echo -e "\033[31mMISSING!\033[0m"
		    echo -e "========= We need that folder for the config files! You can use the next row to create it: ========="
		    echo -e "\033[35mmkdir ${ARMA_DIR}/${NAME}\033[0m\n"
		fi
		...
		echo -ne "\033[33mArma3Profile:\033[0m ${ARMA_DIR}/${NAME}/users/${NAME}/${NAME}.arma3profile "
		if [ -f ${ARMA_DIR}/${NAME}/users/${NAME}/${NAME}.arma3profile ]; then
		    echo -e "\033[32mOK\033[0m"
		else
		    echo -e "\033[31mMISSING!\033[0m"
		    ...
		    echo -n "${ARMA_DIR}/${NAME}/users/${NAME}/${NAME}.arma3profile"
		    echo -e "\n\033[0m"
		fi
		...
		if [ -L ~/.local/share/Arma\ 3\ -\ Other\ Profiles/${NAME}/${NAME}.Arma3Profile ]; then
		    ...
		    echo -e "\033[35mln -s ${ARMA_DIR}/${NAME}/${NAME}.arma3profile ~/.local/share/Arma\ 3\ -\ Other\ 	Profiles/${NAME}/${NAME}.Arma3Profile\033[0m\n"
		fi
